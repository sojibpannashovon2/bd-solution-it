...
const UsersTable = () => {
  return (
    <>
      <Container>
        <div className="bg-white pb-4 px-4 rounded-md w-full my-24 mx-auto m-[90%]">
            ...
            <table className="table-auto border-collapse w-full">
              ...
              <tbody className="text-sm font-normal text-gray-700">
                <tr className="hover:bg-gray-100 border-b border-gray-200 py-10">
                  <td className="px-4 py-4">AzureDevops</td>
                  <td className="px-4 py-4">N/A</td>
                  <td className="px-4 py-4">April 24, 2024, 7:00 pm</td>
                  <td className="px-4 py-4">America/Chicago</td>
                  <td className="px-4 py-4">Join With Zoom Meeting</td>
                </tr>

                <tr className="hover:bg-gray-100 border-b border-gray-200 py-10">
                  <td className="px-4 py-4">DevOps Engineering INT</td>
                  <td className="px-4 py-4">N/A</td>
                  <td className="px-4 py-4">April 25, 2024, 2:00 pm</td>
                  <td className="px-4 py-4">America/Chicago</td>
                  <td className="px-4 py-4">Join With Zoom Meeting</td>
                </tr>

                <tr className="hover:bg-gray-100 border-b border-gray-200 py-10">
                  <td className="px-4 py-4">DevOps Engineering WD</td>
                  <td className="px-4 py-4">N/A</td>
                  <td className="px-4 py-4">December 10, 2024, 7:00 pm</td>
                  <td className="px-4 py-4">America/Chicago</td>
                  <td className="px-4 py-4">Join With Zoom Meeting</td>
                </tr>

                <tr className="hover:bg-gray-100 border-b border-gray-200 py-10">
                  <td className="px-4 py-4">DevOps WD</td>
                  <td className="px-4 py-4">N/A</td>
                  <td className="px-4 py-4">April 2, 2024, 7:00 pm</td>
                  <td className="px-4 py-4">America/Chicago</td>
                  <td className="px-4 py-4">Join With Zoom Meeting</td>
                </tr>

                <tr className="hover:bg-gray-100 border-b border-gray-200 py-10">
                  <td className="px-4 py-4">DevOps Weekend</td>
                  <td className="px-4 py-4">N/A</td>
                  <td className="px-4 py-4">March 30, 2024, 12:00 pm</td>
                  <td className="px-4 py-4">America/Chicago</td>
                  <td className="px-4 py-4">Join With Zoom Meeting</td>
                </tr>

                <tr className="hover:bg-gray-100 border-b border-gray-200 py-10">
                  <td className="px-4 py-4">My Meeting</td>
                  <td className="px-4 py-4">N/A</td>
                  <td className="px-4 py-4">May 1, 2023, 11:00 pm</td>
                  <td className="px-4 py-4">America/Chicago</td>
                  <td className="px-4 py-4">Join With Zoom Meeting</td>
                </tr>
              </tbody>
